...
$ # Go 1.16+
$ go install -tags 'postgres' github.com/Elate-DevOps/migrate/v4/cmd/migrate@$TAG
```
...
$ # Go 1.16+
$ go install -tags 'postgres' github.com/Elate-DevOps/migrate/v4/cmd/migrate@latest
```

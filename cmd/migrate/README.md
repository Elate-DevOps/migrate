...
$ # Go 1.16+
$ go install -tags 'postgres' github.com/FixFi-DevOps/migrate/v4/cmd/migrate@$TAG
```
...
$ # Go 1.16+
$ go install -tags 'postgres' github.com/FixFi-DevOps/migrate/v4/cmd/migrate@latest
```
